...
const StatusPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-sky-100 flex items-center justify-center px-4">
      <div className="bg-white shadow-lg rounded-xl max-w-4xl w-full p-6 flex flex-col relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white shadow-lg p-4 flex justify-between items-center">
